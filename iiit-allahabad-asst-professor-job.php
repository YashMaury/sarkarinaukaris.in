...
<head>
	<title>IIIT Allahabad Recruitment 2023 Apply Asst Professor 18 Post</title>
</head>
	<div class="site grid-container container hfeed" id="page">
		<div class="site-content" id="content">
			<div class="content-area" id="primary">
				<main class="site-main" id="main">
					<article id="post-164180"
						class="post-164180 post type-post status-publish format-standard has-post-thumbnail hentry category-govt-jobs category-latest-notification category-teacher-vacancy"
						itemtype="https://schema.org/CreativeWork" itemscope>
						<div class="inside-article">
							<header class="entry-header" aria-label="Content">
								<h1 class="entry-title" itemprop="headline">IIIT Allahabad Recruitment 2023 Apply Asst
									Professor 18 Post</h1>
								<div class="entry-meta">
									<span class="posted-on"><time class="entry-date published"
											datetime="2023-08-17T10:39:08+05:30" itemprop="datePublished">17 Aug
							...
							<div class="entry-content" itemprop="text">
								<p><span style="color: #000000;"><strong>Name of Post: </strong>Assistant Professor
										(Grade-I, Grade-II) </span>Vacancies 18 Posts.<span
										style="color: #000000;"><strong><br />
											<span style="color: #000000;"><strong>Short
													Information:</strong></span></strong></span> Indian Institute of
									Information Technology Allahabad has released <a
										href="latest-jobs/">a notification</a>. Candidates
									can apply online for 18 posts. Candidates will be selected on the basis of process,
									qualifications, and section. The process of submitting the online form will start on
									7 September 2023.</p>
								<p>Indian Institute of Information Technology, Allahabad (IIITA), Prayagraj (U.P.) is an
									Institute of National Importance established in 2000 by the Ministry of Education,
									Government of India. The Institute offers B.Tech., M.Tech., M.B.A, Ph.D., and other
									programs of contemporary relevance to aspiring learners, in the broad areas of
									Applied Sciences, Electronics, and Communication Engg.</p>
								<p>Information Technology, Management Studies, and their associated niche domains.
									Candidates who are interested in <a
										href="rojgar-result/">IIIT Allahabad Recruitment
										2023</a> can apply online through the official website IIIT Allahabad <span
										style="font-size: inherit;">Jobs from </span><strong
										style="font-size: inherit;">31 August 2023 to 7 September 2023.</strong></p>
								<h2>IIIT Allahabad Jobs Notification 2023 &#8211; Apply Online Assistant Professor 18
									Posts</h2>
								...
								<p>Those Candidates are Interested in IIIT Allahabad Recruitment 2023 the Following IIIT
									Allahabad Asst Professor Vacancy 2023 and Completed the All Eligibility Criteria Can
									Read the <a href="sarkari-exam/">IIIT Allahabad
										Notification 2023</a> Before <a
										href="sarkari-naukri/">IIIT Allahabad Apply Online
										2023</a>. Below is a brief description of the IIIT Allahabad Asst Professor Jobs
									2023 official notification. Other details of the IIIT Allahabad Asst Professor
									Salary, Like Age Limit, Educational Qualification, Selection Process, Application
									Fee, and IIIT Allahabad Apply Online How to Apply are given below.</p>
								<h3 style="text-align: center;">Indian Institute of Information Technology Allahabad
									Recruitment 2023<strong><span style="color: #ffffff;"><br />
										</span></strong></h3>
								<p style="text-align: center;">IIIT Allahabad Vacancy Notification Details<strong><span
								...
								<ul>
									<li>Opening Date for Submission of Online Form: <strong>31 August 2023.</strong>
									</li>
									<li>Closing Date for Submission of Online Form:<strong> 7 September 2023.</strong>
									</li>
								</ul>
								...
								<ul>
									<li>General/OBC category candidate&#8217;s application fee <strong>Rs.
											1180/-</strong></li>
									<li>SC/ST/PWD category candidate&#8217;s application fee is <strong>Nil.</strong>
								...
								<ul>
									<li>The Candidate&#8217;s pay scale is <strong>as per the 7th CPC.</strong></li>
								</ul>
								...
								<ul>
									...
									<li>Job Location: <strong>Allahabad.</strong></li>
								</ul>
								<p style="text-align: center;"><span style="color: #000000;"><b><strong>IIIT Allahabad
												Recruitment Notification</strong> Vacancy Details </b></span><b><span
											style="color: #000000;">Total: 18 P</span></b><b
									...
									<tbody>
										<tr>
											...
											<td style="width: 50%; text-align: center;"><a
													href="https://www.iiita.ac.in/" rel="nofollow noopener">Click
													Here</a></td>
										</tr>
										<tr>
											<td style="width: 50%; text-align: center;">Notification</td>
											<td style="width: 50%; text-align: center;"><a
													href="https://recruitment.iiita.ac.in/faculty_recruitment/index.html"
							...
							<footer class="entry-meta" aria-label="Entry meta">
								...
								<nav id="nav-below" class="post-navigation" aria-label="Posts">
									<div class="nav-previous"><span class="gp-icon icon-arrow-left"><svg
												...
												href="sarkari-naukri/" rel="prev">Sarkari
									...
									<div class="nav-next"><span class="gp-icon icon-arrow-right"><svg
												...
												href="free-job-alert/" rel="next">Free Job
						...
						<div id="comments">
							<div id="respond" class="comment-respond">
								<h3 id="reply-title" class="comment-reply-title">Leave a Comment <small><a
											...
											href="/iiit-allahabad-asst-professor-job/#respond"
								...
								<form action="https://www.sarkariresult.app/wp-comments-post.php" method="post"
									...
									<p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
											...
											value="164180" id="comment_post_ID" />
										<input type="hidden" name="comment_parent" id="comment_parent" value="0" />
									</p>
									<p style="display: none;"><input type="hidden" id="akismet_comment_nonce"
											name="akismet_comment_nonce" value="668e4f6983" /></p>
				...
				<div class="inside-right-sidebar">
					...
					<aside id="recent-posts-2" class="widget inner-padding widget_recent_entries">
						...
						<ul>
							...
							<li>
								<a href="iiit-allahabad-asst-professor-job/"
									aria-current="page">IIIT Allahabad Recruitment 2023 Apply Asst Professor 18 Post</a>
							</li>
							<li>
