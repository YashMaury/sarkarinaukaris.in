...
<head>
	<title>CAG Administrative Assistant Recruitment 2023 Apply Now 1773 Post</title>
</head>
	<div class="site grid-container container hfeed" id="page">
		<div class="site-content" id="content">
			<div class="content-area" id="primary">
				<main class="site-main" id="main">
					<article id="post-164208"
						class="post-164208 post type-post status-publish format-standard has-post-thumbnail hentry category-govt-jobs category-latest-notification"
						itemtype="https://schema.org/CreativeWork" itemscope>
						<div class="inside-article">
							<header class="entry-header" aria-label="Content">
								<h1 class="entry-title" itemprop="headline">CAG Administrative Assistant Recruitment
									2023 Apply Now 1773 Post</h1>
								<div class="entry-meta">
									<span class="posted-on"><time class="entry-date published"
											datetime="2023-08-17T12:22:54+05:30" itemprop="datePublished">17 Aug
							...
							<div class="entry-content" itemprop="text">
								<p><span style="color: #000000;"><strong>Name of Post: </strong></span>Administrative
									Assistant Vacancy at 1773 Posts.<span style="color: #000000;"><strong><br />
											<span style="color: #000000;"><strong>Short
													Information:</strong></span></strong></span> Comptroller and Auditor
									General of India 2023 has announced multiple openings for the positions of
									Administrative Assistant in various departments. Interested candidates should apply
									before the deadline to be considered for the positions. Applications for<a
										href="free-job-alert/"> CAG Administrative
										Assistant recruitment</a> have been sought online. Online application is
									available from <strong>17 August 2023 to 17 September 2023.<br />
									</strong>Indian Audit and Accounts Department proposes to frame Recruitment Rules
									(RRs) for the post of Administrative Assistant (Level 4 in pay matrix). The proposed
									RRs containing draft Notification and Schedule have been framed in accordance with
									instructions issued by the Department of Personnel and Training
									(DoPT).<strong><br />
									</strong></p>
								<h2>CAG Jobs 2023 &#8211; Apply Online Administrative Assistant 1773 Posts</h2>
								<p>You can find here the eligibility criteria to apply for the Comptroller and Auditor
									General of India Recruitment 2023. The age limit, minimum qualification, number of
									vacancies, and pay scale for <a
										href="sarkari-naukri/">CAG Administrative
										Assistant Online Form 2023</a> are given below. Below is a brief description of
									the <a href="rojgar-result/">CAG Administrative
										Assistant Jobs 2023</a>
								...
								</div> official notification. Other details of the CAG Administrative Assistant
								Recruitment 2023 Syllabus Like Age Limit, Educational Qualification, Selection Process,
								Application Fee, and How to Apply are given below.</p>
								<h3 style="text-align: center;">Comptroller and Auditor General of India Recruitment
									2023<strong><span style="color: #ffffff;"><br />
										</span></strong></h3>
								<p style="text-align: center;">CAG Administrative Assistant Notification
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td>Bachelor’s Degree from a recognized University.<br />
												Minimum Computer proficiency qualification.<br />
												Higher Secondary School Certificate with computer proficiency-related
												courses as one of the subjects under the Central or State Board of
												School Education; or<br />
												(b) Knowledge of computer application equivalent to the Course on
												Computer Concepts (CCC) of the National Institute of Electronics and
												Information Technology (NIELIT) or Diploma in Computer or Certificate in
												Computer Application from a recognized institute.</td>
										</tr>
									</tbody>
								</table>
								...
								<table
									...
									<tbody>
										...
										<tr>
											...
											<td style="width: 50%; text-align: center;">17 August 2023</td>
										</tr>
										<tr>
											<td style="width: 50%; text-align: center;">Last Date for Submission of
												Online Application Form</td>
											<td style="width: 50%; text-align: center;">17 September 2023</td>
										</tr>
									</tbody>
								</table>
								<p><span style="text-decoration: underline;"><strong>Pay Details</strong></span></p>
								<ul>
									<li>The selected candidates through the CAG Administrative Assistant Recruitment
										will be given a pay of <strong>Level 4</strong>.</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>Age Limit</strong></span></p>
								<ul>
									<li>Minimum Age: <strong>18 years.</strong></li>
									<li>Maximum Age:<strong> 25 years.</strong>
								...
								<table
									...
									<tbody>
										...
										<tr>
											<td style="width: 50%; text-align: center;">Administrative Assistant</td>
											<td style="width: 50%; text-align: center;">1773</td>
										</tr>
									</tbody>
								</table>
								...
								<ul>
									<li>Postal Address: <strong>Shri Nilesh Patil, Asstt. C &amp;AG (N)-I, O/o the
											C&amp;AG of India, 9, Deen Dayal Upadhyay Marg, New Delhi- 110124.</strong>
									</li>
									<li>Mode of Apply: Through <strong>Online.</strong></li>
									<li>Job Location: <strong>All India.</strong></li>
								</ul>
								<p style="text-align: center;"><span style="color: #000000;"><b><strong>CAG Recruitment
												Notification</strong> Vacancy Details </b></span><b><span
											style="color: #000000;">Total: 1773 </span></b><b
									...
									<tbody>
										<tr>
											...
											<td style="width: 50%; text-align: center;"><a
													href="https://www.placementstore.in/category/notification.php?id=12uRL5vLv6iS3SHfpc9pFskkz5wjJ3PJX&amp;name=CAG%20Administrative%20Assistant%20Notification%202023"
							...
							<footer class="entry-meta" aria-label="Entry meta">
								...
								<nav id="nav-below" class="post-navigation" aria-label="Posts">
									<div class="nav-previous"><span class="gp-icon icon-arrow-left"><svg
												...
												rel="prev">WhatsApp Group Links 2023 Sarkari Result Group Direct Join
												Links</a></span></div>
									<div class="nav-next"><span class="gp-icon icon-arrow-right"><svg
												...
												href="rojgar-result/" rel="next">Rojgar
						...
						<div id="comments">
							<div id="respond" class="comment-respond">
								<h3 id="reply-title" class="comment-reply-title">Leave a Comment <small><a
											...
											href="/cag-administrative-assistant-recruitment/#respond"
								...
								<form action="https://www.sarkariresult.app/wp-comments-post.php" method="post"
									...
									<p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
											...
											value="164208" id="comment_post_ID" />
										<input type="hidden" name="comment_parent" id="comment_parent" value="0" />
									</p>
									<p style="display: none;"><input type="hidden" id="akismet_comment_nonce"
											name="akismet_comment_nonce" value="7451299589" /></p>
				...
				<div class="inside-right-sidebar">
					...
					<aside id="recent-posts-2" class="widget inner-padding widget_recent_entries">
						...
						<ul>
							...
							<li>
								<a href="cag-administrative-assistant-recruitment/"
									aria-current="page">CAG Administrative Assistant Recruitment 2023 Apply Now 1773
									Post</a>
							</li>
							<li>
