...
<head>
	<title>Indian Coast Guard Civilian Recruitment 2023 Application 25 Post</title>
</head>
					...
					<article id="post-163437"
						...
						<div class="inside-article">
							<header class="entry-header" aria-label="Content">
								<h1 class="entry-title" itemprop="headline">Indian Coast Guard Civilian Recruitment 2023
									Application 25 Post</h1>
							...
							<div class="entry-content" itemprop="text">
								<p><span style="color: #000000;"><strong>Name of Post: </strong></span>Indian Coast
									Guard Driver, Multi Tasking Staff, Unskilled Worker Various Posts 2023 Application
									Form<span style="color: #000000;"><strong><br />
											<span style="color: #000000;"><strong>Short
													Information:</strong></span></strong></span> Indian Coast Guard has
									...
									Lascar, Engine Driver, Draftsman 25 posts through <a
										href="rojgar-result/">Indian Coast Guard Civilian
										Recruitment 2023</a> has been issued an  Indian Coast Guard Jobs 2023
									notification has been published. Interested and eligible applicants fill in all
									required details for the Indian Coast Guard Vacancy and send the Indian Coast Guard
									Lascar application to the given address before the last date of application given in
									the <a href="latest-jobs/"> Indian Coast Guard
										notification</a>. The applications for various types of posts in the Indian
									Coast Guard will start from 5 August 2023.</p>
								<h2>Indian Coast Guard Jobs Notification 2023 &#8211; Application Form MTS, Store
									Keeper, Welder, Draftsman 25 Posts</h2>
								<p>Those Candidates Are Interested in Indian Coast Guard Recruitment 2023 the Following
									Indian Coast Guard MTS Vacancy 2023 and Completed the All Eligibility Criteria Can
									Read the Indian Coast Guard Notification 2023 Before <a
										href="sarkari-naukri/">Indian Coast Guard
										Application Form</a> 2023.</p>
								<p>Below is a brief description of the <a
										href="sarkari-exam/">Indian Coast Guard Jobs
										2023</a>
								...
								</div> official notification. Other details of the Indian Coast Guard Store Keeper
								Syllabus Like Age Limit, Educational Qualification, Selection Process, Application Fee,
								and Indian Coast Guard Driver Salary and How to Apply are given below.</p>
								<h3 style="text-align: center;">Indian Coast Guard Recruitment 2023<strong><span
											style="color: #ffffff;"><br />
										</span></strong></h3>
								<p style="text-align: center;">Indian Coast Guard Vacancy Notification
									Details<strong><span style="color: #ffffff;"><br />
										</span></strong></p>
								<p><span style="text-decoration: underline;"><strong>Eligibility </strong></span></p>
								<ul>
									<li>Candidates should have passed ITI, 10th Class, 12th Class, or equivalent from a
									...
									<tbody>
										...
										<tr>
											<td style="width: 50%; text-align: center;">Last Date for Submission of
												Application Form</td>
											<td style="width: 50%; text-align: center;">Update Soon</td>
										</tr>
									</tbody>
								</table>
								<p><span style="text-decoration: underline;"><strong>Application Fee</strong></span></p>
								<ul>
									<li>Enclosed is a separate self-addressed blank envelope affixed with a postal stamp
										of Rs.50/-. This envelope should not be enclosed with the application.</li>
								</ul>
								...
								<table>
									<thead>
										<tr>
											<th>Name of Posts</th>
											<th>Pay Level</th>
											<th>Pay Scale (7th Pay Matrix)</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>Store Keeper</td>
											<td>Level-2</td>
											<td>Rs. 19900-63200/-</td>
										</tr>
										<tr>
											<td>Welder (Skilled)</td>
											<td>Level-2</td>
											<td>Rs. 19900-63200/-</td>
										</tr>
										<tr>
										...
										<tr>
											<td>Civilian Motor Transport Driver</td>
											<td>Level-2</td>
											<td>Rs. 19900-63200/-</td>
										</tr>
										<tr>
											<td>Multi Tasking Staff (Peon/ Sweeper)</td>
											<td>Level-1</td>
											<td>Rs. 18000-56900/-</td>
										</tr>
										<tr>
											<td>Unskilled Labour &amp; Lascar</td>
											<td>Level-1</td>
											<td>Rs. 18000-56900/-</td>
										</tr>
										<tr>
								...
								<p><span style="text-decoration: underline;"><strong>Indian Coast Guard Vacancy
								...
								<ul>
									<li>Selection depends on Written Test, Skill Test, Document Verification and Medical
										Fitness.</li>
								</ul>
								...
								<ul>
									...
									<li>Postal Address: <strong>Commander, Coast Guard Region (West), Worli Sea Face
											P.O. Worli Colony, Mumbai- 400030.</strong>
								...
								<p style="text-align: center;"><span style="color: #000000;"><b><strong>Indian Coast
												Guard Recruitment Notification</strong> Vacancy Details
										</b></span><b><span style="color: #000000;">Total: 25 </span></b><b
								...
								<table
									...
									<tbody>
										...
										<tr>
											...
											<td style="width: 50%; text-align: center;"><a
													href="https://www.placementstore.in/category/notification.php?id=1AENqLpQ07h_82lqyerSMUlR8uXxLbsxE&amp;name=Indian%20Coast%20Guard%20Driver,%20MTS,%20Draughtsman%20Notification%202023%20Apply%2025%20Post"
													rel="nofollow noopener">Click Here</a></td>
										</tr>
										<tr>
							...
							<footer class="entry-meta" aria-label="Entry meta">
								...
								<nav id="nav-below" class="post-navigation" aria-label="Posts">
									<div class="nav-previous"><span class="gp-icon icon-arrow-left"><svg
												...
												rel="prev">Gurdaspur Court Stenographer Recruitment 2023 Apply Form 12
												Post</a></span></div>
									<div class="nav-next"><span class="gp-icon icon-arrow-right"><svg
												...
												rel="next">RRC NCR Recruitment 2023 JE, ALP, Tech, Train Manager 323
												Post</a></span></div>
								</nav>
							</footer>
						</div>
						...
						<div id="comments">
							<div id="respond" class="comment-respond">
								<h3 id="reply-title" class="comment-reply-title">Leave a Comment <small><a
											...
											href="/indian-coast-guard-civilian-jobs/#respond"
								...
								<form action="https://www.sarkariresult.app/wp-comments-post.php" method="post"
									...
									<p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
											...
											value="163437" id="comment_post_ID" />
										<input type="hidden" name="comment_parent" id="comment_parent" value="0" />
									</p>
									<p style="display: none;"><input type="hidden" id="akismet_comment_nonce"
											name="akismet_comment_nonce" value="f063dce715" /></p>
