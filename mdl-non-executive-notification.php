...
<head>
	<title>MDL Non-Executive Recruitment 2023 Driver, Translator 531 Post</title>
</head>
	<div class="site grid-container container hfeed" id="page">
		<div class="site-content" id="content">
			<div class="content-area" id="primary">
				<main class="site-main" id="main">
					<article id="post-164073"
						class="post-164073 post type-post status-publish format-standard has-post-thumbnail hentry category-govt-jobs category-latest-notification"
						itemtype="https://schema.org/CreativeWork" itemscope>
						<div class="inside-article">
							<header class="entry-header" aria-label="Content">
								<h1 class="entry-title" itemprop="headline">MDL Non-Executive Recruitment 2023 Driver,
									Translator 531 Post</h1>
								<div class="entry-meta">
									<span class="posted-on"><time class="entry-date published"
											datetime="2023-08-16T11:16:44+05:30" itemprop="datePublished">16 Aug
							...
							<div class="entry-content" itemprop="text">
								<p><span style="color: #000000;"><strong>Name of Post: </strong></span>Mazagon Dock MDL
									Skilled I, Semi-Skilled, Special Recruitment 203 for 531 Posts<span
										style="color: #000000;"><strong><br />
											<span style="color: #000000;"><strong>Short
													Information:</strong></span></strong></span> Mazagon Dock
									Shipbuilders Limited (MDL) has recently announced <a
										href="latest-jobs/">Mazagon Dock notification</a>
									for the <a href="rojgar-result/">MDL Non-Executive
										recruitment</a> of Non-Executives under the trades – Skilled I, Semi-Skilled,
									Special Grade (ID-VIII), Special Grade (ID-IX) posts on fixed term contract basis
									for a period of 03 years and may be extended by minimum 01 years. The online
									application process for eligible applicants to MDL Non-Executive apply online is
									available at mazagondock.in and the window will be open from 12 August 2023 to 21
									August 2023.</p>
								<h2>MDL Jobs Notification 2023 &#8211; Apply Online Skilled, Semi-Skilled 531 Posts</h2>
								<p>Those Candidates Are Interested in Mazagon Dock Non-Executive Recruitment 2023 the
									Following Mazagon Dock Vacancy 2023 and Completed the All Eligibility Criteria Can
									Read the MDL Notification 2023 Before <a
										href="sarkari-naukri/">Mazagon Dock Non-Executive
										Apply Online</a> 2023.</p>
								<p>Below is a brief description of the <a
										href="sarkari-exam/">MDL Jobs 2023</a> official
									notification. Other details of the MDL Non-Executive Syllabus Like Age Limit,
									Educational Qualification, Mazagon Dock Bharti 2023 Selection Process, Application
									Fee, and Mazagon Dock Non-Executive Jobs 2023 How to Apply are given below.</p>
								<h3 style="text-align: center;">Mazagon Dock Shipbuilders Limited Recruitment
									2023<strong><span style="color: #ffffff;"><br />
										</span></strong></h3>
								<p style="text-align: center;"><a
										href="rojgar-result/">MDL Non-Executive
								...
								<ul>
									<li>Candidates must have passed <strong>10th Class, Diploma, Degree, Master&#8217;s
											Degree,</strong>
										...
										</div> or equivalent from a recognized Board/ University/ Institution.
									</li>
								</ul>
								...
								<table
									...
									<tbody>
										...
										<tr>
											...
											<td style="width: 50%; text-align: center;">12 August 2023</td>
										</tr>
										<tr>
											<td style="width: 50%; text-align: center;">Last Date for Submission of
												Online Application Form</td>
											<td style="width: 50%; text-align: center;">21 August 2023</td>
										</tr>
									</tbody>
								</table>
								<p><span style="text-decoration: underline;"><strong>Application Fee</strong></span></p>
								<ul>
									<li>For General/OBC/EWS candidates application fee<strong> Rs.100/-.</strong></li>
									<li><strong>No fee</strong> for SC/ ST/ PWD (Persons With Disability) &amp;
										Ex-servicemen candidates application fee.</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>Pay Scale</strong></span></p>
								<ul>
									<li>Skilled I Post Pay Scale <strong>Rs. 17000 to Rs. 64360/-.</strong></li>
									<li>Semi-Skilled Post Pay Scale <strong>Rs. 13200 to Rs. 49910/-. </strong></li>
									<li>Special Grade (ID-VIII) Post Pay Scale <strong>Rs. 21000 to Rs.
											79380/-.</strong></li>
									<li>Special Grade (ID-IX) Post Pay Scale <strong>Rs. 22000 to Rs. 83180/-.</strong>
									</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>Age Limit</strong></span></p>
								<ul>
									<li>The maximum age limit is 38 years and the minimum age limit should not be less
										than 18 years as on 01 August 2023.</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>MDL Vacancy Details</strong></span>
								</p>
								<table>
									<thead>
										<tr>
											<th><strong>Trades</strong></th>
											<th><strong>Vacancy Count</strong></th>
										</tr>
									</thead>
									<tbody>
										<tr>
										...
										<tr>
											<td>Special Grade (ID-VIII)</td>
											<td>2</td>
										</tr>
										<tr>
											<td>Special Grade (ID-IX)</td>
											<td>1</td>
										</tr>
									</tbody>
								</table>
								...
								<ul>
									<li>Candidates will be called for Written Test, Trade/Skill Test.</li>
									<li>Trade/Skill Test will be of a qualifying nature only. Candidates who have
										secured more marks in experience will be placed higher in merit.</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>How to Apply</strong></span></p>
								<ul>
									<li>Please visit the official website mazgondock.in.</li>
									<li>Then applicants click on careers, find and click on the advertisement reference.
										Serial Number: MDL/HR-TA-CC-MP/97/2023 &#8211; Recruitment of Non-Executives on
										Fixed Term Contract basis for a period of 03 years and extendable up to a
										maximum of 01 year + 01 year.</li>
									...
									<li>Now the candidate has to check the eligibility.</li>
									<li>The candidate has to click on Non-Executive.</li>
									<li>Then the candidate has to enter the details in the online form.</li>
									<li>The candidate has to pay the fee.</li>
									<li>Finally, check the filled form and submit it.</li>
									<li>Mode of Apply: Through <strong>Online.</strong></li>
									<li>Job Location: <strong>Mumbai.</strong></li>
								</ul>
								<p style="text-align: center;"><span style="color: #000000;"><b><strong>MDL
												Non-Executive Recruitment Notification</strong> Vacancy Details
										</b></span><b><span style="color: #000000;">Total: 531 </span></b><b
									...
									<tbody>
										<tr>
											...
											<td style="width: 50%; text-align: center;"><a
													href="https://mazagondock.in/app/MDLJobPortal/Login.aspx?msg=n"
													rel="nofollow noopener">Click Here</a></td>
										</tr>
										<tr>
											<td style="width: 50%; text-align: center;">Notification</td>
											<td style="width: 50%; text-align: center;"><a
													href="https://www.placementstore.in/category/notification.php?id=1UzIZIu-snT3AJj0krYioXs7ldjNbisOH&amp;name=MDL%20Non-Executive%20Notification%202023%20Apply%20Online%20531%20Post"
													rel="nofollow noopener">Click Here</a></td>
										</tr>
										<tr>
							...
							<footer class="entry-meta" aria-label="Entry meta">
								...
								<nav id="nav-below" class="post-navigation" aria-label="Posts">
									<div class="nav-previous"><span class="gp-icon icon-arrow-left"><svg
												...
												href="bau-non-teaching-recruitment/"
												rel="prev">BAU Non-Teaching Recruitment 2023 Clerk, Attendant, Manager
												82 Post</a></span></div>
									<div class="nav-next"><span class="gp-icon icon-arrow-right"><svg
												...
												rel="next">BEL Panchkula Recruitment 2023 Apply Online Engineer 57
												Post</a></span></div>
								</nav>
							</footer>
						</div>
						...
						<div id="comments">
							<div id="respond" class="comment-respond">
								<h3 id="reply-title" class="comment-reply-title">Leave a Comment <small><a
											...
											href="/mdl-non-executive-notification/#respond" style="display:none;">Cancel
											reply</a></small></h3>
								<form action="https://www.sarkariresult.app/wp-comments-post.php" method="post"
									...
									<p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
											...
											value="164073" id="comment_post_ID" />
										<input type="hidden" name="comment_parent" id="comment_parent" value="0" />
									</p>
									<p style="display: none;"><input type="hidden" id="akismet_comment_nonce"
											name="akismet_comment_nonce" value="32db6b0441" /></p>
				...
				<div class="inside-right-sidebar">
					...
					<aside id="recent-posts-2" class="widget inner-padding widget_recent_entries">
						...
						<ul>
							...
							<li>
								<a href="mdl-non-executive-notification/"
									aria-current="page">MDL Non-Executive Recruitment 2023 Driver, Translator 531
									Post</a>
							</li>
						</ul>
					</aside>
