...
<head>
	<title>ISEC Recruitment 2023 Walk In Interview for Listers, Mappers Post</title>
</head>
	<div class="site grid-container container hfeed" id="page">
		<div class="site-content" id="content">
			<div class="content-area" id="primary">
				<main class="site-main" id="main">
					<article id="post-164241"
						class="post-164241 post type-post status-publish format-standard has-post-thumbnail hentry category-govt-jobs category-latest-notification"
						itemtype="https://schema.org/CreativeWork" itemscope>
						<div class="inside-article">
							<header class="entry-header" aria-label="Content">
								<h1 class="entry-title" itemprop="headline">ISEC Recruitment 2023 Walk In Interview for
									Listers, Mappers Post</h1>
								<div class="entry-meta">
									<span class="posted-on"><time class="entry-date published"
											datetime="2023-08-17T17:15:30+05:30" itemprop="datePublished">17 Aug
							...
							<div class="entry-content" itemprop="text">
								<p><span style="color: #000000;"><strong>Name of Post: </strong></span>ISEC Listers,
									Mappers Various Posts 2023 Notification<span style="color: #000000;"><strong><br />
											<span style="color: #000000;"><strong>Short
													Information:</strong></span></strong></span> Institute for Social
									and Economic Change (ISEC) applications are invited to release the latest <a
										href="latest-jobs/">ISEC District notification</a>
									on its website for the post of Listers, Mappers on a contract basis in the Project
									&#8220;National Family Health Survey-6, in PRC at ISEC&#8221;. Interested persons
									waiting is over today they may appear for a walk-in interview in ISEC on 18 August
									2023 along with your CV, and Originals Graduation Certificate for Verification.
									candiadtes can do <a href="sarkari-exam/">ISEC
										Recruitment</a> by downloading ISEC District Vacancy offline application form
									from the official website. We have given here a direct link to ISEC Jobs for
									applicants to fill ISEC Offline Application Form by 2 September 2023. For further
									details please Contact Prof C M Lakshmana, Project Coordinator (email <a
										href="/cdn-cgi/l/email-protection" class="__cf_email__"
										data-cfemail="bef2dfd5cdd6d3dfd0dffed7cddbdd90ddc890d7d0">[email&#160;protected]</a>)
									Contact no: Mob 9449989931/8660647257.</p>
								<h2>ISEC Jobs Notification 2023 &#8211; Walk In Listers, Mappers 40 Post</h2>
								<p>Those Candidates Are Interested in ISEC Recruitment 2023 the Following ISEC Vacancy
									2023 and Completed the All Eligibility Criteria Can Read the ISEC Notification 2023
									Before <a href="sarkari-naukri/"> ISEC Application
										Form</a> 2023. Below is a brief description of the <a
										href="rojgar-result/"> ISEC Jobs 2023</a> official
									notification. Other details of the ISEC Listers, Mappers Salary Like Age Limit,
									Educational Qualification, Selection Process, Application Fee, and How to Apply are
									given below.</p>
								<h3 style="text-align: center;">Institute for Social and Economic Change Recruitment
									2023<strong><span style="color: #ffffff;"><br />
										</span></strong></h3>
								<p style="text-align: center;">ISEC Listers, Mappers Notification Details<strong><span
											style="color: #ffffff;"><br />
										</span></strong></p>
								<p><span style="text-decoration: underline;"><strong>Eligibility </strong></span></p>
								<ul>
									<li>Candidates should have <strong>Any Graduation Degree (Preferably Social
											Sciences/ Geography)</strong> or equivalent from a recognized Board/
										University/ Institution.</li>
									<li>Knowledge of Kannada is essential.</li>
									<li><strong>Desirable Qualifications:</strong> working experience in Major Surveys
										like NFHS/ DLHS/ WHO etc.</li>
								</ul>
								...
								<table
									...
									<tbody>
										<tr>
											<td style="text-align: center;" colspan="2"><strong>ISEC Walk-In Interview
													Important Date</strong></td>
										</tr>
										<tr>
											<td style="width: 50%; text-align: center;">Notification Release Date</td>
											<td style="width: 50%; text-align: center;">11 August 2023</td>
										</tr>
										<tr>
											<td style="width: 50%; text-align: center;">Walk-In-Interview</td>
											<td style="width: 50%; text-align: center;">18 August 2023</td>
										</tr>
									</tbody>
								</table>
								...
								<ul>
									<li>ISEC Listers, Mappers Post Salary <strong>Rs. 21000 per month and Rs. 400 DA per
											day</strong>
										...
										</div> during the survey period.
									</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>Age Limit</strong></span></p>
								<ul>
									<li>Age limit as per recruitment rules.</li>
								</ul>
								<p><span style="text-decoration: underline;"><strong>ISEC Vacancy
											Details</strong></span></p>
								<ul>
									<li>Mappers: 20 Posts.</li>
									<li>Listers: 20 Posts.</li>
									<li>Total: 40 Posts</li>
								</ul>
								...
								<ul>
									...
									<li>Job Location: <strong>Bengaluru, Karnataka.</strong></li>
								</ul>
								<p style="text-align: center;"><span style="color: #000000;"><b><strong>ISEC Recruitment
									...
									<tbody>
										<tr>
											...
											<td style="width: 50%; text-align: center;"><a
													href="https://www.placementstore.in/category/notification.php?id=1j0_sApyVH-TsgGyRkcvtyzY6h92OrKu2&amp;name=ISEC%20Listers,%20Mappers%20Walk%20In%20Interview%20Notification%202023"
							...
							<footer class="entry-meta" aria-label="Entry meta">
								...
								<nav id="nav-below" class="post-navigation" aria-label="Posts">
									<div class="nav-previous"><span class="gp-icon icon-arrow-left"><svg
												...
												href="high-court-jobs/" rel="prev">High
						...
						<div id="comments">
							<div id="respond" class="comment-respond">
								<h3 id="reply-title" class="comment-reply-title">Leave a Comment <small><a
											...
											href="/isec-walk-in-interview-for-listers-mappers-post/#respond"
								...
								<form action="https://www.sarkariresult.app/wp-comments-post.php" method="post"
									...
									<p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
											...
											value="164241" id="comment_post_ID" />
										<input type="hidden" name="comment_parent" id="comment_parent" value="0" />
									</p>
									<p style="display: none;"><input type="hidden" id="akismet_comment_nonce"
											name="akismet_comment_nonce" value="c740f85bd4" /></p>
			...
			<div class="widget-area sidebar is-right-sidebar" id="right-sidebar">
				<div class="inside-right-sidebar">
					...
					<aside id="recent-posts-2" class="widget inner-padding widget_recent_entries">
						...
						<ul>
							<li>
								<a href="isec-walk-in-interview-for-listers-mappers-post/"
									aria-current="page">ISEC Recruitment 2023 Walk In Interview for Listers, Mappers
									Post</a>
							</li>
							<li>
